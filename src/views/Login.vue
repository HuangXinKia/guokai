  ...
  <div class="login_box">
    ...
    <div class="login">
      ...
      <form method="post">
        ...
        <span
          id="password_text"
          onclick="this.style.display='none';document.getElementById('password').style.display='block';document.getElementById('password').focus().select();"
          >密码</span
        >
        <input
          name="password"
    ...
    <!-- <div class="copyright">权鑫网络信息技术有限公司 版权所有©2022 </div> -->
  </div>
</template>
